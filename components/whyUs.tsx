...
export const whyChooseUs = [
  ...
  },
  {
    ...
    description: "At Muze Tubyine, we are committed to delivering exceptional results that drive success."
  },
  {
    title: "Great team",
        ...
        <div className="md:px-[150px] px-4 mx-auto">
          <div className="justify-center items-center text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-4">
              Why Choose Muze Tubyine ?
            </h2>
            <p className="text-center text-white text-lg max-w-2xl mx-auto  ">
              Ready to take your organization to the next level? Contact Muze Tubyine
